            ...
            SizedBox(
              ...
              child: RadioListTile<enum_Colors>(
                ...
                onChanged: (enum_Colors? value) {
                  setState(() {
                    _colour = value;
                    functions.instance.Dataclass.data["Color Red"] = true;
                    functions.instance.Dataclass.data["Color Blue"] = false;
                    functions.instance.Dataclass.data["Colour"] = 0;
                  });
                },
              ),
            ),
            SizedBox(
              ...
              child: RadioListTile<enum_Colors>(
                ...
                onChanged: (enum_Colors? value) {
                  setState(() {
                    _colour = value;
                    functions.instance.Dataclass.data["Color Red"] = false;
                    functions.instance.Dataclass.data["Color Blue"] = true;
                    functions.instance.Dataclass.data["Colour"] = 1;
                  });
                },
              ),
            ),
